module SSS
  # Anything you do that makes a request to S3 could result in an error. If it does, the SSS library will raise an exception 
  ...
  # 
  #   error
  #   # => #<SSS::BucketNotEmpty The bucket you tried to delete is not empty>
  #   error.message
