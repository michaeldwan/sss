module SSS
  ...
  #   pp policy.grants
  #   [#<SSS::ACL::Grant FULL_CONTROL to noradio>,
  #    #<SSS::ACL::Grant READ to AllUsers Group>]
  # 
  ...
  # 
  #   grant = ACL::Grant.new
  #   # => #<SSS::ACL::Grant (permission) to (grantee)>
  ...
  #   # => #<SSS::ACL::Grantee (xsi not set yet)>
  # 
  ...
  #   grant
  #   # => #<SSS::ACL::Grant READ_ACP to AllUsers Group>
  # 
