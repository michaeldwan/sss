module SSS
  ...
  # 
  #   Service.buckets
  #   # => [#<SSS::Bucket @attributes={"name"=>"jukebox"}>]
  # 
  ...
  #   # => [#<SSS::S3Object '/jukebox/black-flowers.mp3'>]
  # 
  ...
  class Bucket < Base
    class << self
      ...
      #     # => [<SSS::S3Object '/jazz/miles.mp3'>, <SSS::S3Object '/jazz/dolphy.mp3'>, <SSS::S3Object '/classical/malher.mp3'>]
      #     Bucket.objects('jukebox', :prefix => 'classical')
      #     # => [<SSS::S3Object '/classical/malher.mp3'>]
      #
      ...
      #   # => [<SSS::S3Object '/jazz/miles.mp3'>, <SSS::S3Object '/classical/malher.mp3'>]
      #
      ...
      # List all your buckets. This is a convenient wrapper around SSS::Service.buckets.
    ...
    #
    #   bucket.objects
    #   => [#<SSS::S3Object '/marcel_molina/beluga_baby.jpg'>,
    #       #<SSS::S3Object '/marcel_molina/tongue_overload.jpg'>]
