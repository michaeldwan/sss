  ...
  class Connection #:nodoc:
    ...
    private
      ...
      def add_user_agent!(request)
        request['User-Agent'] ||= "SSS/#{VERSION}"
      end
    ...
    module Management #:nodoc:
      ...
      # Manage the creation and destruction of connections for SSS::Base and its subclasses. Connections are
      ...
      module ClassMethods
        ...
        #
        # You can set connections for every subclass of SSS::Base. Once the initial connection is made on
        ...
        # option. 
        #
        #   SSS::Bucket.established_connection!(:use_ssl => true)
        #
        ...
        #   
        #   SSS::Bucket.established_connection!(:proxy => {
